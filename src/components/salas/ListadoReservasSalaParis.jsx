...
const ListadoReservasSalaParis = () => {
  const {
    reservasSalaParis,
    obtenerSalaParis,
    seleccionSala,
              ...
              return (
                <tr key={halfHourIndex}>
                  ...
                  {diasSemana.map((dia, diaIndex) => {
                    const reserva = reservasSalaParis.find(
                      (reserva) =>
...
export default ListadoReservasSalaParis;
