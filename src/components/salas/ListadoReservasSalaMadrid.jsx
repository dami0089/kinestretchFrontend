...
const ListadoReservasSalaMadrid = () => {
  const {
    clientes,
    setObtenerUs,
    setSeleccion,
              ...
              return (
                <tr key={halfHourIndex}>
                  ...
                  {diasSemana.map((dia, diaIndex) => {
                    const reserva = reservasSalaMadrid.find(
                      (reserva) =>
...
export default ListadoReservasSalaMadrid;
