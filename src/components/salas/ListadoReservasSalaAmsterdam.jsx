...
const ListadoReservasSalaAmsterdam = () => {
  const {
  ...
  useEffect(() => {
    const obtenerInfo = async () => {
      await obtenerSalaAmsterdam(lunes);
    };
    obtenerInfo();
  }, []);
              ...
              return (
                <tr key={halfHourIndex}>
                  ...
                  {diasSemana.map((dia, diaIndex) => {
                    const reserva = reservasSalaAmsterdam.find(
                      (reserva) =>
...
export default ListadoReservasSalaAmsterdam;
